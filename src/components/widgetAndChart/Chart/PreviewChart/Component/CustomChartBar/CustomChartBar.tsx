            ...
            >
                <defs>
                    <linearGradient id="active" x1="0" y1="0" x2="0" y2="1">
                        <stop offset="0%" stopColor="rgb(0, 141, 175)" />
                        <stop offset="100%" stopColor="rgb(48, 214, 235)" />
                    </linearGradient>
                    <linearGradient id="default" x1="0" y1="0" x2="0" y2="1">
                        <stop offset="0%" stopColor="rgb(141, 141, 141)" stopOpacity={0.2} />
                        <stop
                            offset="100%"
                            stopColor="rgba(181, 181, 181, 0.2)"
                            stopOpacity={0.2}
                        />
                    </linearGradient>
                </defs>
                ...
                <XAxis
                    dataKey="group"
                    tick={{ fill: "var(--var-7)", fontSize: 12 }}
                    axisLine={false}
                    tickLine={false}
                />
