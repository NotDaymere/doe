...
interface UploadFilesProgressIconProps extends React.SVGProps<SVGSVGElement> {
    fill?: string;
    width?: string | number;
...
const UploadFilesProgressIcon: FC<UploadFilesProgressIconProps> = ({
                                             fill = "#8BCF16",
                                             width = "10",
                                             height = "12",
                                             opacity = 1,
...
export default UploadFilesProgressIcon;
