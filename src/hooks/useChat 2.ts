...
export const useChat = (setShowSidebar: React.Dispatch<React.SetStateAction<boolean>>) => {
    ...
    const addMessage = (
        ...
        setMessages((prev) => [...prev, { role, content, noTypeEffect, mathBlock, hasCode }]);
    };
