            ...
            <div className={styles.generalTab__content}>
                ...
                <div className={styles.generalTab__setting__container}>
                    ...
                    <div className={styles.generalTab__setting__control}>
                        <button
                            className={styles.generalTab__knowledgeBtn}
                            onClick={() => moveToKnowledge()}
                        >
                            See knowledge
                        </button>
                        <UploadButton
                        ...
                        >
                            <AttachmentIcon width={13.5} height={15} />
                            Upload
                        </UploadButton>
                    </div>
                </div>
                ...
                <div className={styles.generalTab__accounts__container}>
                        ...
                        return (
                            <div key={profile.id} className={styles.generalTab__account__container}>
                                ...
                                <div className={styles.generalTab__account__actions}>
                                    <button className={styles.generalTab__account__logout}>
                                        Log Out <LogOutIcon />
                                    </button>
                                    <button
                                        className={classNames(
                                            modalStyles.settingsModal__deleteBtn,
                                            styles.generalTab__account__delete
                                        )}
                                    >
                                        Delete
                                    </button>
                    ...
                    <div className={styles.generalTab__account__add__container}>
                        ...
                        <button className={styles.generalTab__account__addBtn}>
                            <AddProfilePhotoIcon />
                            Add account
                        </button>
                    </div>
                ...
                <div className={styles.generalTab__setting__container}>
                    ...
                    <button
                        className={classNames(
                            styles.generalTab__account__logout,
                            styles.generalTab__contactBtn
                        )}
                    >
                        <EmailIcon />
                        Contact Us
