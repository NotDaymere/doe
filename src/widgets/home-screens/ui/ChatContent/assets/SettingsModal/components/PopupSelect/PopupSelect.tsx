...
export const PopupSelect = ({ options, value, onChange }: PopupSelectProps) => {
    ...
    useEffect(() => {
        if (options.length && options.every((option) => option.value !== selected)) {
    ...
    return (
        <button
            ref={buttonRef}
            className={clsx(styles.popupSelect, menuState.active && styles["popupSelect--open"])}
                ...
                >
                    ...
                    >
                        {options.map((option) => (
                            <button
                                className={clsx(
                                    styles.popupSelect__menu__item,
