...
export const PersonalizationModel = ({
    ...
    onCreate,
    onDelete,
}: PersonalizationModelProps) => {
    const isPersona = type === "persona";
    return (
        <div className={styles.personalization__container}>
            <div className={styles.personalization__header}>
                <h3 className={styles.personalization__header__title}>
                    {isPersona ? "Persona" : "Writing Style"}
                </h3>
                <div className={styles.personalization__header__icon}>
                    {isPersona ? <SmileIcon /> : <WritingStyleIcon />}
                </div>
            </div>
            <div className={styles.personalization__content}>
                {!!list.length && (
                    <div>
                        <h3 className={styles.personalization__content__title}>
                            Your {isPersona ? "Personas" : "Writing Styles"}
                        </h3>
                        <div className={styles.personalization__list__wrapper}>
                            <div className={styles.personalization__list__container}>
                                {list.map((item) => (
                                    <button
                                        key={item.value}
                                        className={styles.personalization__list__item}
                                    >
                                        <p className={styles.personalization__list__item__name}>
                                            {item.label}
                                        </p>
                                        <div
                                            className={styles.personalization__list__item__controls}
                                        >
                                            <button
                                                className={
                                                    styles.personalization__list__item__controlBtn
                                                }
                ...
                <button
                    className={clsx(
                        styles.personalization__createBtn,
                        isPersona
                ...
                >
                    <MagicIcon />
                    Create {isPersona ? "Persona" : "Writing Style"}
                    <div className={styles.personalization__createBtn__plusIconContainer}>
                        <CrossIcon />
                    </div>
                </button>
            </div>
