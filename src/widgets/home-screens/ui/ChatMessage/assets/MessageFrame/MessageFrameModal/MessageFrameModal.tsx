...
const MessageFrameModal: FC<MessageFrameModalProps> = ({ title, subTitle, iframeUrl }) => {
            ...
            <div className="message-frame">
                <div className="message-frame-titlebar">
                    <div className="window-controls">
                        <div className="window-control modal_minimize"></div>
                        <div className="window-control maximize" onClick={handleCloseModal}>
