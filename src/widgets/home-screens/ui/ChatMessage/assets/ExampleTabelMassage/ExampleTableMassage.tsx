        ...
        <div className={"example-table-massage-container"}>
            ...
            <div className={"example-table-massage"}>
                <text className={"message-text"}>
                    Here's a simple project idea: a Task Manager command-line application in Python.
                    It will allow you to add, view, and delete tasks. In the structure, we'll be
                    able to add and view all tasks, delete tasks by number:
                </text>
                <ExampleCode />
